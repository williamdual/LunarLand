...
namespace godot {
class MascotPart : public EnvObject {
    // this macro sets up a few internal things
	GDCLASS(MascotPart, EnvObject);
...
public:
	...
	// To be extra clear: The parent in the SceneTree will be Crane (as set up by add_child); the parent in our internal transformation hierarchy will be another MascotPart according to the assignment and set up by you! 
	void set_parent(MascotPart* parent); 
	MascotPart* get_parent(); 
